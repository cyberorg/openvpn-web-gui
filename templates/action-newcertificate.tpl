<form name="mainform" method="post" action="{$smarty.server.PHP_SELF}?Action=NewCertificate">
...
<td colspan="2"><input type="text" name="Password" size="40" maxlength="64" value="{$Default.password}"></td>
</tr>
